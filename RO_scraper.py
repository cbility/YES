from common.RO import *
from common.RO import RO_login
from common.RO import RO_logout
from common.RO import LoginFailed
from common.RO import gspread_set_RO_stats
from common.RO import gspread_get_RO_stats
from common.RO import get_pending_certificates
from common.RO import get_oldest_not_issued_dates

from common.gspread_functions import gspread_getbool, gspread_update_stats
        ...
        for i in range(len(stationNames)):
            ...
            try:
                if gspread_getbool(last_login_succesful[i]):
                    ...
                    (
                        oldest_ROCs_not_issued[i],
                        oldest_REGOs_not_issued[i],
                    ) = get_oldest_not_issued_dates(
                        stationNames[i],
                        usernames[i],
                        oldest_ROCs_not_issued,
                        oldest_REGOs_not_issued,
                    ...
                    (
                        ROCs_pending_transfer[i],
                        REGOs_pending_transfer[i],
                        oldest_ROCs_pending[i],
                        oldest_REGOs_pending[i],
                    ) = get_pending_certificates(stationNames[i], usernames[i], driver)
