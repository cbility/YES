...
const response = await quickFileAPIRequest("/document/upload", uploadRequest) as DocumentUploadResponse;

//return response;

//helper functions

async function quickFileAPIRequest(endpoint: string, body: RequestBody, method: "POST" = "POST") {  //remove export to use in Ply
